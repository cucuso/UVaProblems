...
For example, if four events are correctly ordered 1 2 3 4 then the order 1 3 2 4 would receive a score
of 2 using the first method (events 1 and 4 are correctly ranked) and a score of 3 using the second
...
public class HistoryGrading {
  ...
  public static void run() throws IOException {
    ...
    System.setIn(new FileInputStream(new File("java/sample-inputs/history-grading.txt")));
